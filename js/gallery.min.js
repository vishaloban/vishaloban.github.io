        ...
        init: function(b) {
            ...
            return this.each(function(c) {
                ...
                var f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F = !0,
                    ...
                    Z = !1;
                g = J.children(".placeholder").first(), g.length || (J.wrapInner(a('<div class="placeholder hoverable"></div>')), g = J.children(".placeholder").first()), M.length || (M = a('<div class="gallery-header invisible"></div>'), L.length ? L.after(M) : N.append(M));
